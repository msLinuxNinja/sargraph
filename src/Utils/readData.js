...
const parseRow = row => { // parses rows and identifies if there's AM/PM or not in the second column, diferentiating between 12hr and 24hr formats (different versions of sar)
...
function readData(data) { //used when uploading file through the dropzone
    try {
        // console.log(data);
